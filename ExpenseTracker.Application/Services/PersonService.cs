...
public class PersonService : IPersonService
{
    ...
    public async Task<Result<PersonResponse>> CreateAsync(CreatePersonRequest request)
    {
        ...
        {
            var realMessage = ex.GetBaseException()?.Message ?? ex.Message;
    ...
    public async Task<Result<PersonResponse>> GetByIdAsync(Guid id)
    {
    ...
    public async Task<Result<PeopleReportResponse>> GetPeopleSummaryAsync()
    {
        ...
        var groups = q.GroupBy(t => new { t.PersonId, Name = t.Person!.Name })
